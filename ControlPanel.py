...
class ControlPanel(qw.QWidget):
    ...
    def __init__(self, entry_boxes, params, dropdown_choices, dropdown_tooltips):
        ...
        self.entry_blocks["A"] = {"widget": self.A_entry, "is_matrix": True}
        ...
        self.entry_blocks["l"] = {"widget": self.l_entry, "is_matrix": True}
        ...
        self.entry_blocks["p0"] = {"widget": self.p_entry, "is_matrix": True}
        matrix_layout1.addWidget(self.l_entry)
        ...
        self.entry_blocks["b_bar"] = {"widget": self.b_entry, "is_matrix": True}
        ...
        self.entry_blocks["c_bar"] = {"widget": self.c_entry, "is_matrix": True}
        ...
        self.entry_blocks["q0"] = {"widget": self.q_entry, "is_matrix": True}
        ...
        self.entry_blocks["s0"] = {"widget": self.s_entry, "is_matrix": True}
        ...
        for name, entry in entry_boxes.items():
            ...
            self.entry_blocks[name] = {"widget": widget, "is_matrix": False}
        ...
        self.entry_blocks["eta"] = {"widget": self.eta_entry, "is_matrix": True}
        matrix_layout3.addWidget(self.eta_entry)

        self.kappa_entry = MatrixEntry("kappa", r"$\mathbf{\kappa}= $", (3,1), params.kappa.reshape(-1,1))
        self.kappa_entry.textChanged.connect(self.update_plot)
        self.entry_blocks["kappa"] = {"widget": self.kappa_entry, "is_matrix": True}
        ...
        for param in params_dict:
            if param in self.entry_blocks:
                if self.entry_blocks[param]["is_matrix"]:
                    ...
                    self.entry_blocks[param]["widget"].entry.setText(str(param))
