...
def get_trajectories(params: Params):
    ...
    T = params.T
    for i in range(T):
        # step your trajectories, append i to t
        yield dict(traj), t.copy() # <- Protip: return copies to avoid mutability shenanigans

    # example static template
    # run your code, create your traj dictionary and your t dictionary
