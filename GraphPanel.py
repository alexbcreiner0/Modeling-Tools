...
class GraphPanel(qw.QWidget):
    ...
    def _plot_on_axis(self, axis, traj, t, dropdown_choice, options):
    ...
    def make_plot(self, traj, t, dropdown_choice, options):
        ...
        for ax in self.axes:
            ...
            self._plot_on_axis(ax, traj, t, dropdown_choice, options)
    ...
    def plot_slot(self, slot_index, dropdown_choice, options, slot_config= None):
        ...
        self._plot_on_axis(ax, self.traj, self.t, dropdown_choice, options)
        ...
        if slot_config is None:
            ...
            if display_title: ax.set_title(title)
